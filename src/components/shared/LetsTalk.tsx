            ...
            <div className="relative flex flex-col items-center gap-1">
                ...
                >
                    ...
                    <button
                        ...
                        className="group mt-4 flex cursor-pointer items-center gap-2 text-xs tracking-widest uppercase text-muted-foreground transition-all duration-500"
                        style={{
                            transform: showSuccess ? "translateY(0)" : "translateY(10px)",
                            opacity: showSuccess ? (isBackHovered ? 1 : 0.6) : 0,
                ...
                >
                    <div className="flex flex-col items-center gap-6">
                        <h2
                            className="relative text-center mb-2 text-4xl font-light tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl leading-[1.1] transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
                            style={{
                                opacity: isClicked ? 0 : 1,
                        ...
                        <div className="relative flex size-16 items-center justify-center">
                            ...
                            />
                            <ArrowUpRight
                                className="size-6 text-foreground transition-all ease-[cubic-bezier(0.16,1,0.3,1)] sm:size-7"
                                style={{
                                    transform: isClicked
                ...
                >
                    ...
                    <Link href="mailto:Kerlosssony@gmail.com" className="text-xs tracking-widest uppercase text-muted-foreground/60">Kerlosssony@gmail.com</Link>
                </div>
            </div>
        </section>
    )
